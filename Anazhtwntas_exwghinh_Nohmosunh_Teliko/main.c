...
int main(void) {
    int pinakas[10005], index, count, apotelesma = 0, num, kr;
    ...
    for (index = 3; index < num; index++) {
        ...
        for (count = 1, kr = index / 2 + 1; count < index; count += 2, kr++) {
            if (pinakas[count] == pinakas[index] && pinakas[kr] > pinakas[count] * 2 && table[kr] != 255) {
                table[kr] = 255;
                apotelesma++;
            }
    ...
    if (pinakas[0] == 987) {
        ...
        for (count = 1, kr = num / 2 + 1; count < num; count += 2, kr++) {
            ...
            if (pinakas[count] == pinakas[num] && pinakas[kr] > pinakas[count] * 2 && table[kr] != 255) {
